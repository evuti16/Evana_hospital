    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        AccountType accountType = rbdoctor.isSelected() ? AccountType.DOCTOR :AccountType.PATIENT;
          ...
          try {
            ...
            PreparedStatement pst=connection.prepareStatement("select * from user where email = ? and role= ?");
            ...
            if (new PasswordConfig().decrypt(password,resultSet.getString("password") )){
                if(accountType.equals(AccountType.PATIENT)){
                    PreparedStatement pst2=connection.prepareStatement("select * from patient where email=?");
                ...
                PreparedStatement pst3=connection.prepareStatement("select * from doctor where email=?");
           ...
           JOptionPane.showMessageDialog(this,"Wronggg");
        }
